...
dataDir='/home/davinci/dnn/data/coco2017'
dataType=[ 'train2017', 'val2017', 'test2017' ]
dataPrefix = 'coco2017'

outDir='/home/davinci/dnn/data/my_person/coco2017'
listFile = [  '/home/davinci/dnn/data/my_person/coco2017/train.txt',
              '/home/davinci/dnn/data/my_person/coco2017/val.txt',
              '/home/davinci/dnn/data/my_person/coco2017/test.txt' ]

for i in range(len(dataType)):
    print 'process data type %s' % dataType[i]
    annFile = '{}/annotations/instances_{}.json'.format(dataDir, dataType[i])
    if (dataType[i] == 'test2017'):
